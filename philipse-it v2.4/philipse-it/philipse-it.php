...
Description: Philipse IT Websupport | websupport@philipse-it.nl
...
function my_login_logo() { ?>
  <style type="text/css">
	...
	body{
		background: url('/wp-content/plugins/philipse-it/img/background.jpg') !important;
...
function my_login_logo_url() {
    return "https://philipse-it.nl";
}
add_filter( 'login_headerurl', 'my_login_logo_url' );



//EINDE LOGIN PAGINA EDIT
}
